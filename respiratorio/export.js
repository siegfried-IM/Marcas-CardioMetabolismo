(function () {
  ...
  function dashboardData() {
    return window.OTC_DASHBOARD || null;
  }

  function regionalData() {
    return window.OTC_DATA || null;
  }
  ...
  function workbookFileName(dash) {
    ...
    return "Respiratorio_Datos_" + stamp + ".xlsx";
  }
  ...
  function buildWorkbook() {
    ...
    if (common && common.appendTableSheet) {
      ...
      common.finalizeWorkbook(workbook, context, entries, {
        kind: "Dashboard + DDD Respiratorio"
      });
      return workbook;
    }
  ...
  window.exportOtcWorkbook = function () {
    ...
    if (!dashboardData() || !regionalData()) {
      window.alert("No se encontro la data de Respiratorio para exportar.");
      return;
    }
      ...
      .then(function () {
        window.setTimeout(function () {
          try {
            ...
            console.error(error);
            window.alert("No se pudo generar el Excel de Respiratorio.");
          } finally {
